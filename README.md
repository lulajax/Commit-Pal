...
5. 在右侧的 **"Weekly Report Prompt"** 区域可以自定义项目报告生成提示词
6. 点击 **"生成项目报告"** 调用 LLM 生成项目报告
7. 点击 **"复制项目报告"** 复制到剪贴板
